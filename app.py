...
with open ('../datasets/master_plan_boundaries.json', 'r') as jsonFile:
...
def main():
    ...
    with central:
        ...
        choro_map =fs.Choropleth(geo_data = town_borders,
                                 ...
                                 line_color = 'black',
                                 nan_fill_opacity = 0.3).add_to(m) #applies this choropleth to the map we called earlier
